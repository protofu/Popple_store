      ...
      <div className="flex flex-col justify-center items-center bg-white rounded-xl p-5 w-[50%] h-[80%] gap-5 px-36 border-2 border-popple-light">
        ...
        <div className="w-full">
          <div className={oneLineStyle}>
            ...
            <input type="text" value={exhi.exhibitionName} className={inputStyle} />
          </div>
          <div className={oneLineStyle}>
            <p className="inline">예약 날짜</p>
            <input type="text" value={reservationTime} className={inputStyle} />
          </div>
        </div>
        {/* 예약자 정보 */}
        ...
        <div className="w-full">
          <div className={oneLineStyle}>
            ...
            <input value={exhi.exhibitionName} className={inputStyle}/>
          </div>
          <div className={oneLineStyle}>
            <p className="inline">이메일</p>
            <input value={reservationTime} className={inputStyle} />
          </div>
          <div className={oneLineStyle}>
