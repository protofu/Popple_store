...
public class ExhibitionController {
	...
	@PatchMapping("")
	public ResponseEntity<ExhibitionResponse> updatePopUp(Long id, ExhibitionRequest exhibitionRequest, @AuthenticationPrincipal User user) throws IOException {
		ExhibitionResponse exhibition = exService.updateExhibition(id, exhibitionRequest, user);
